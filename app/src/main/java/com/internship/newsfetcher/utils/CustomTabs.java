package com.internship.newsfetcher.utils;
...
/**
 * Created by Suraj Kumar Gupta on 5/11/2020
 */
public class CustomTabs {
    ...
    public static void openTab(Context context, String url) {
        ...
        boolean isInstalled = isPackageInstalled(PACKAGE_NAME, context.getPackageManager());
